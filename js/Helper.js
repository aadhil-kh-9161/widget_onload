            ...
            init: function() {
            	if(!isInitTriggered)
            	{
                    ...
                    appSDK.OnLoad(function() {
                        appSDK.getContext().Event.Trigger('ZDK_EVENT', {action : 'get_zdk_url'}, true)
                            .then(function (url) {
                                self._zdksdk = appSDK;
                                ...
                                console.error('ZDK import failed', e);
                                promiseResolve();
                            });
                    });
        ...
        CRM: (function() {
            ...
            return {
                ...
                CONNECTION: {
                     ...
                     * @param {Object} req_data - Request Data
                     * @param {String} req_data.url - Request url
                     * @param {String} [req_data.method=GET] - request method
                     * @param {Object} [req_data.parameters] - Request parameters
                     * @param {Object} [req_data.headers] - Request headers
                     * @param {Integer} req_data.param_type - Request parameter type - 1 for params, 2 for payload
                     * @example
